...
324 / (324+111) * 100 ## Percentage

## Filter out manip check failures. 
...
## Effect size 
F_to_eta2(f = c(16.485, 0.754, 0.321), df = c(1,1,1), df_error = c(577, 577, 577), ci = .90, alternative = "greater")
